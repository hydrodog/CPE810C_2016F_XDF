...
int main(){
    ...
    while(getline(inf,onefont)){
        allfont=allfont+onefont;
    }
    //wcout<<allwords<<endl;
    //cout<<allfont<<endl;
    ...
    //allfont="languageChinesecolorbluefonttimessize28bold0italic0underline0end<stylechange>languageChinesecolorbluefonttimessize28bold0italic0underline0end<stylechange>";
    Text test1;
    ...
    //int i=1;
    //Content test2=test1.getcontent(i);
    //wstring a1=test1.getContentword(0);
   // a1=L"打发士大夫十分生动";
    //wstring a1=test2.getword();
    //const wchar_t *a3=a1.c_str();
    //string a2;
    //wcout<<a1;
    //Wchar_tToString(a2,a3);
    //cout<<a2;
    return 0;
}
