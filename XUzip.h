/*
This is the specification of the XUzip.cpp, which are the combination of some codes from the zlib library.
Because there are too many files in the zlib library and I just used some of them, so I choose the XUnzip.h codes from internet.
Some of them I used in my program, some of them are not.
*/
